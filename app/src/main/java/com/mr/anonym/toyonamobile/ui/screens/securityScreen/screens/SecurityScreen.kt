            ...
            SecurityFields(
                ...
                onCheckedChange = {
                    coroutineScope.launch {
                        TODO(
                        dataStore.saveIsBiometricAuthOn(it)
                        dataStore.saveBiometricAuthState(it)
                    }
                },
                onContentClick = {
            ...
            when{
                isChangePinProcess.value->{
                    SecurityDialog(
                        ...
                        quaternaryColor = quaternaryColor,
                        fiverdColor = fiverdColor,
                        title = R.string.are_you_sure_to_change_pin_code,
                        onDismissClick = {
                ...
                isChangePasswordProcess.value->{
                    SecurityDialog(
                        ...
                        quaternaryColor = quaternaryColor,
                        fiverdColor = fiverdColor,
                        title = R.string.are_you_want_to_change_password,
